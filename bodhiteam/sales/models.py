...
class Lead(models.Model):
    ...
    is_this_reassigned_lead = models.BooleanField(default=False) 
...
class Conversion(models.Model):
    sales_user = models.ForeignKey(SalesExecutive,related_name='sales_user_conversion',on_delete=models.SET_NULL,blank=True,null=True)
    total_conversion = models.IntegerField(blank=True)
    total_conversion_amount = models.IntegerField(blank=True)
    datetime = models.DateTimeField(default=datetime.datetime.now())

    def __str__(self):
        return self.sales_user.name + ' ' + str(self.total_conversion) + ' ' + str(self.total_conversion_amount)
