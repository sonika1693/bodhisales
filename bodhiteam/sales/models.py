...
class Lead(models.Model):
    ...
    assignedTo = models.ForeignKey(SalesExecutive,related_name='lead_assign',blank=True,null=True,on_delete=models.CASCADE)
    workedBy = models.ManyToManyField(SalesExecutive,related_name='lead_second_assign',blank=True,null=True)
...
class FeedBack(models.Model):
    ...
    by = models.ForeignKey(SalesExecutive,related_name='feedback_person',blank=True,null=True,on_delete=models.CASCADE)
    lead = models.ForeignKey(Lead,related_name='feeback_lead',on_delete=models.CASCADE)
    ...
    nextCall = models.ForeignKey(SalesExecutive,related_name='feedback_nextcall',blank=True,null=True,on_delete=models.CASCADE)
...
class DemoFeedback(models.Model):
    ...
    price_quoted = models.CharField(max_length=200,blank=True,null=True,default=12000)
    datetime = models.DateTimeField(default=datetime.datetime.now())
